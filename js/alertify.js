        ...
        _alertify = {
            ...
            addListeners: function (fn) {
                ...
                common = function (event) {
                    self.hide();
                    self.unbind(document.getElementById('ajax-content'), "keyup", key);
                ...
                this.bind(document.getElementById('ajax-content'), "keyup", key);
            ...
            build: function (item) {
                ...
                html += "<img src=\"images/info.gif\" style=\"float: left\" />";
            ...
            init: function () {
                ...
                if ($("alertify-cover") == null) {
                    ...
                    elCover.className = "alertify-cover alertify-cover-hidden";
                    document.getElementById('ajax-content').appendChild(elCover);
                }
                // main element
                if ($("alertify") == null) {
                    isopen = false;
                    ...
                    document.getElementById('ajax-content').appendChild(elDialog);
                }
                // log element
                if ($("alertify-logs") == null) {
                    ...
                    document.getElementById('ajax-content').appendChild(elLog);
                }
                // set tabindex attribute on body element
                // this allows script to give it focus
                // after the dialog is closed
                document.getElementById('ajax-content').setAttribute("tabindex", "0");
                // set transition type
