...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('#content, .snap-content, .content, .container, .sidebar-logo-close, .ajax-menu').click(function () {
        ...
        /*    $('.staff-item').mousedown(function () {
         $(".owl-wrapper").attr("class", "dontdragg");
         });
         $('.owl-item').mousedown(function () {
         $(".owl-wrapper").attr("class", "dontdragg");
         });
         $('.staff-slider').mousedown(function () {
         $(".owl-wrapper").attr("class", "dontdragg");
         });
         */
